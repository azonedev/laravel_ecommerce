...
<div class="col-lg-9 main-chart">
	<div class="border-head">
 	...
 	<div class="row mt">
    	<div class="col-lg-12">
  			<div class=" form">
          @foreach($editslider as $slidervalue)
 			<form method="post" action="{{url('updateslider')}}/{{$slidervalue->id}}" class="cmxform form-horizontal style-form" id="commentForm" enctype="multipart/form-data">
                  @csrf
                  ...
                  <div class="form-group ">
                    ...
                    <div class="col-lg-10">
                      <input class=" form-control" id="cname" name="subtitle" minlength="2" type="text" value="{{$slidervalue->subtitle}}">
                    </div>
                  </div>
                  <div class="form-group ">
                    <label for="cname" class="control-label col-lg-2">Feature Image</label>
                    <div class="col-lg-10">
                      <input class=" form-control" id="cname" name="feature_image" minlength="2" type="file" value="{{$slidervalue->feature_image}}" >
                    </div>
                  </div>
                  <div class="form-group">
