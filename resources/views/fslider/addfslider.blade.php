...
@section('maincontent')
@if(Session::has('fslider-save-msg'))
<div class="alert alert-success"><b>Well done!</b> New feature slider added successfully.</div>
@endif
<div class="col-lg-9 main-chart">
	<div class="border-head">
 	...
 	<div class="row mt">
    	<div class="col-lg-12">
  			<div class=" form">
 			<form action="{{route('fslider.save')}}" method="post" class="cmxform form-horizontal style-form" id="commentForm" enctype="multipart/form-data">
                  @csrf
