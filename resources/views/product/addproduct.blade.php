...
@endif
            <div class=" form">
                <form action="{{route('product.save')}}" method="post" class="cmxform form-horizontal style-form" id="commentForm" enctype="multipart/form-data">
                  @csrf
         ...
         <div class="form-group ">
          ...
          <div class="form-group ">
           ...
           <div class="col-lg-10">
                      <input class="form-control " id="cemail" type="number" name="flate_price" value="">
                    </div>
                  </div>
          ...
          <label for="cemail" class="control-label col-lg-2"> Product Short Description</label>
                  ...
                  <div class="col-lg-10">
           <textarea style="margin: 0px; height: 158px; width: 680px;padding:20px" id="mytextarea" name="shortdes">HWrite your product short description here ...</textarea>
         </div>
         </div>
            ...
            <div class="col-lg-10">
           <textarea style="margin: 0px; height: 158px; width: 680px;padding:20px" name="product_info" >Write your product info here..</textarea>
         </div>
                  </div>
